...
function StatusCard() {
    return(
         <div className='hover:scale-102 flex flex-col bg-[#1e1e1e] border-2 border-[#292929] w-full mx-auto h-auto rounded-xl transition-all ease-in-out duration-500 mb-4 px-4 md:px-8 py-6'>
                ...
                <ul className="list-disc ml-6 marker:text-[#d3aef6] text-gray-300 text-sm md:text-base font-semibold mb-1">
                    <li className="mb-2">{personalData.major} Student with a {personalData.minor} @ {personalData.school}</li>
