...
function Hero() {
    return(
            <div id="home" className="w-auto h-screen bg-linear-to-br bg-gradient-to-b from-transparent via-transparent to-[#121212] flex flex-col items-center justify-center">
