...
const Contact = () => {
  return (
    <div id="contact" className='w-auto h-screen flex flex-row justify-center items-center'>
        <div className='w-10/12 md:w-8/12 grid lg:grid-cols-2 h-auto justify-center gap-10'>
            ...
            <div className='flex justify-center '>
                <form className='w-full flex flex-col gap-4 text-white text-xs md:text-base' action="https://formspree.io/f/xwpbjqjv" method="POST">
                    ...
                    <button type="submit" className="cursor-pointer text-xs md:text-base bg-black rounded-2xl px-4 py-3 w-fit opacity-80 text-left font-semibold border border-[#292929]">Submit</button>
                </form>
            </div>
        </div>
    </div>
